...
def root_newtonraphson(f,df,x0,epsilon,delta):
    ...
    steps = 0
    while steps < 100: #100 steps as max. limit
...
def fit_powerlaw(dataX,dataY):
    ...
    px,prs = linearfit_leastsquare(logxdata,logydata)
...
def fit_exponential(dataX,dataY):
    ...
    #using least square fit for linear form
    px,prs = linearfit_leastsquare(dataX,logydata) #prs is pearson r square
